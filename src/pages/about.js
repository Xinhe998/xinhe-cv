                ...
                <div id="about-page">
                    ...
                    <div className="main-content">
                        ...
                        <div className="quick_fact_img_group">
                            <Lightbox
                                images={[{ src: quick_fact3 }, { src: quick_fact4 }, { src: quick_fact5 }, { src: quick_fact1 }, { src: quick_fact2 }, { src: quick_fact6 }]}
                            ...
                            />
                            <img src={quick_fact3} className="vertical"  onClick={() => this.openLightbox(0)} />
                            <img src={quick_fact4} className="vertical"  onClick={() => this.openLightbox(1)} />
                            <img src={quick_fact5} className="vertical"  onClick={() => this.openLightbox(2)} />
                            <br />
                            <img src={quick_fact1} className="horizontal"  onClick={() => this.openLightbox(3)} />
                            <img src={quick_fact2} className="horizontal"  onClick={() => this.openLightbox(4)} />
                            <img src={quick_fact6} className="horizontal"  onClick={() => this.openLightbox(5)} />
