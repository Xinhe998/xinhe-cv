    ...
    resources: {
      ...
      en: {
        translation: {
          ...
          web_front_end_dev: "Front-End Development",
          web_front_end: "Web Front-End",
          back_end_dev: "Back-End Development",
          web_back_end_dev: "Web Back-End Development",
          web_back_end: "Back-End",
          database: "Databases",
          ...
          advantech_overview: "Within the 6-months internship, I mainly collaborated with the manager, and was responsible for <1>{{marketplace}}Advantech Marketplace</1> project development and testing.",
          advantech_dutie1: "Partnered with the manager, project manager, UI/UX designers and software engineers to develop Marketplace project and Advantech official website, participated every weekly meeting to synchronize project progress with team. ",
          advantech_dutie2: "Leaded the implementation of End-to-End testing with 50 test cases using Selenium and efficiently built CI pipeline in one week. Enabled the parallel testing in multiple browsers and servers. The result was reducing 10% of labor costs of website deployment in the team.",
          advantech_dutie3: "Conducted a transnational conference to share the experience on coded UI testing with IT team members and China-based QA team members.",
          advantech_dutie4: "Reported KPI and the progress of the projects to CTO in every monthly meeting, discussed the project goals together.",
          advantech_dutie5: "Leaded a new intern and conducted the project handover, wrote the test scenarios and coached the program development to make him be familiar with the project.",
          advantech_dutie6: "Adjusted Advantech Member system in order to comply with EU GDPR.",
          ...
          meracle_brief2: "Our team consisted of four peoples, completed this project with an app by cross-platform mobile framework React Native, a web system by React.js, and RESTful API by ASP.NET API 2. I participate in all processes, but I especially contributed the most to front-end development.",
          here_brief1: "HERE is <1>a website platform based around the concept of bartering.</1> The inspiration comes from the story that started with the trading of a paper clip and ended with a house. <3></3>HERE aims to <5>H</5>elp <7>E</7>veryone, <9>R</9>euse <11>E</11>verything. It allows donors that have different demands, such as releasing ending inventory in an enterprise, contributing unwanted item in home, to post the stuff online.",
          ...
          self_intro3: "Currently I am majoring in Information Application at National Taichung University of Science and Technology. Since I started the five-year program when I was 15, and got to know more about information literacy, code structure and development process etc., I have 2+ years of experience on web development and I processed experience as an intern in three companies.",
          ...
          verizon_overview: "As a Front-End Engineer intern, I was responsible for ‘<1>{{yahoo_youcard}}Yahoo Youcard</1>’ project growth, and delivering a final presentation to colleagues.",
          verizon_dutie1: "Worked on a Scrum team for 4 sprints, participated the stand-up meeting every day and planning, review and retrospective meeting once every two weeks, solved difficulties together with the team.",
          verizon_dutie2: "Brainstorm with teams for the solution of problems in Yahoo Youcard project, built a Progressive Web Application (PWA) in order to drive more traffic to website and increase engagement rate.",
          verizon_dutie3: "Implemented cache strategy and enabled offline reading in PWA, that contributed to 35% faster in speed of page loading.",
          verizon_dutie4: "Improved SEO by adding the structured data, resulted in double website traffic.",
          verizon_dutie5: "Optimized performance by lazy loading, reducing bundle sizes and generating animations using plain CSS in React framework.",
          verizon_dutie6: "Leaded the implementation of the latest Trusted Web Activity (TWA) technique to save the labor costs of Android app development.",
          codio_desc: "Online Collaborative IDE for Web Development",
          codio_overview1: "The Graduate College Team Project",
          codio_brief1: "Codio is an online editor for web developers prototyping new ideas, collaborating in real-time with HTML, CSS and JavaScript. Additionally, Codio lets you generate resume by projects.",
          codio_brief2: "Our team consisted of four peoples, I collaborated with one teammate to build Front-End user interfaces and functions with React in this project. Alongside this, I was individually responsible for architecting a CI/CD pipeline with CircleCI and AWS.",
          codio_brief3: "This project is still ongoing and <1>planned to be launched</1> in 2020.",
        },
      },
      tw: {
        translation: {
          ...
          advantech_overview: "在六個月的實習中，我主要與公司協理配合，使用 ASP.NET MVC 進行<1>{{marketplace}}研華雲端軟體市集</1>專案的開發。",
          advantech_dutie1: "與協理、PM、UI/UX 設計師及多位工程師合作開發雲端軟體市集和研華官方網站，每週參與團隊會議同步專案進度。",
          advantech_dutie2: "主導為研華導入 Selenium 網頁自動化測試 (End-to-End Testing)，有效率地撰寫了50項測試案例，達到多瀏覽器與多伺服器之平行測試，並完成持續整合 (CI) 流程，減少部門 10% 網站部署的人力資源成本。",
          advantech_dutie3: "舉辦跨國技術分享會議，主講教導中國大陸與台北總部的IT人員有關網頁自動化測試的程式撰寫並分享相關經驗。",
          advantech_dutie4: "在每月月會中與CTO稟報負責的專案進度與KPI，共同討論專案執行目標。",
          advantech_dutie5: "帶領新加入的實習生並進行專案交接，負責撰寫測試腳本，供其進行程式開發以熟悉專案。",
          advantech_dutie6: "負責調整研華會員系統功能，以符合歐盟GDPR法規。",
          program_lang: "程式語言",
          ...
          here_brief1: "HERE 這禮是個<1>基於以物易物、禮物經濟概念的平台。</1>靈感來自於從迴紋針換到一棟房的故事。<3></3>HERE 的宗旨在於「<5>H</5>elp <7>E</7>veryone, <9>R</9>euse <11>E</11>verything」。 讓各種不同目的的捐贈者（企業打消期末存貨、家庭二手物品、愛心捐款者等）將物資放上網站，並讓有需求的慈善團體、弱勢家庭或任何有需求之族群至平台上選取需求物資。",
          ...
          verizon: "Verizon Media",
          verizon_overview: "擔任前端實習生的兩個月中，我負責的是參與及協助 「<1>{{yahoo_youcard}}Yahoo 懶人卡</1>」 專案的成長，並且對全公司進行最終成果發表簡報。",
          verizon_dutie1: "加入 Scrum team 與圖隊一起經歷了 4 個 sprints，每日與團隊一同參與 stand-up meeting、及每兩週一次的 planning meeting, reviewing 與 retro meeting，並和團隊共同解決遇到的困難。",
          verizon_dutie2: "與團隊一起進行創意發想，思考 Yahoo! 懶人卡專案中問題的解決方案，最後決議打造 PWA，目的為導入更多流量與使用者互動率。",
          verizon_dutie3: "建構 PWA，導入 cache 與離線瀏覽機制，使網頁載入速度成長 35%。",
          verizon_dutie4: "加入結構化資料 (Structured Data) 以增進 SEO，促使懶人卡網站流量成長將近兩倍。",
          verizon_dutie5: "在 React 框架中透過實作 lazy loading、減少專案 bundle sizes、以純 CSS 改寫複雜的動畫特效等進行網頁效能調校。",
          verizon_dutie6: "主導引入最新 Trusted Web Activity(TWA) 技術，節省開發 Android APP 的人力成本。",
          codio_desc: "雲端即時共同協作的網頁程式 IDE",
          codio_overview1: "大學畢業專題",
          codio_brief1: "Codio 是一雲端線上程式碼編輯器，目前開放前端基礎程式語言HTML、CSS、JavaScript，提供網頁開發者學習與製作想法原型，並且與同伴即時共同編輯。Codio 也提供讓開發者根據平台上累積的專案，產出個人化的求職履歷，凸顯個人特色與實務開發能力。",
          codio_brief2: "我們的團隊由四個人所組成，我與另一位組員合作進行網頁前端介面與功能之建置。除此之外，我亦獨自負責使用CircleCI與AWS來建構持續整合與持續交付(CI/CD)管道。",
          codio_brief3: "此份專案目前仍在開發進行中，預計將於2020年上線。",
        },
      },
    },
    // debug: true,
